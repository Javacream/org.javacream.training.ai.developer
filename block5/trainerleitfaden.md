# Trainerleitfaden – Block 5: RAG mit Spring AI
...
Die Teilnehmenden bauen aus Retrieval und ChatClient eine vollständige RAG-Anwendung und können typische Qualitätsprobleme systematisch analysieren.
...
- Naiver RAG-Ablauf
- Retrieval-Kontext und Antwortgenerierung
- QuestionAnswerAdvisor
- RAG über die Advisor Chain
- Chunking-Strategie und Retrieval-Qualität
- Quellen und Nachvollziehbarkeit
- Umgang mit fehlendem Wissen
- Modellwissen versus Memory versus RAG-Wissen
...
- **RAG-Advisor einsetzen:** Binde den VectorStore mit QuestionAnswerAdvisor in den ChatClient ein.
- **Grounded Prompting:** Gib der Anwendung vor, nur auf Basis der Wissensbasis zu antworten und Wissenslücken explizit zu benennen.
- **Quellen sichtbar machen:** Ergänze Metadaten so, dass sich gefundene Dokumente fachlich nachvollziehen lassen.
- **Fehleranalyse:** Teste mindestens eine Frage mit guter, eine mit schwacher und eine ohne passende Retrieval-Grundlage.
